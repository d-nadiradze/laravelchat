...
socket.on('chat_message', function (data) {
    if (data['users_message'] == auth_user && data.attachment != null && data.message != null) {
        $("#sms").append(`
        ...
        <div class="chat-message mt-3">
            ...
            <div class="group flex flex-row items-center">
                <span class="px-4 py-2 rounded-lg inline-block rounded-bl-none bg-gray-300 text-gray-600">
                    ${data.message}
                 <img src="img/${data.user}${data.attachment}" class="object-contain h-48 w-full rounded-lg p-1 py-1.5" alt="">
                </span>
